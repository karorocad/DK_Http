...
{
public class HttpIn : GH_Component
{
    ...
    (
        "DK_HttpIn",
        "DK_HttpIn",
        "Listens for HTTP requests on a local port",
        "DK Server",
        "Http Server"
    )
	{
	...
	protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
	{
        ...
        pManager.AddTextParameter("prefix", "Prefix", "address to be listened", GH_ParamAccess.item, "http://127.0.0.1:8080/");
	}//eof
	...
	{
        get { return new Guid("{6e4671ab-4212-4abe-9910-c5f8abfbf7c1}"); }
	}
}//eoc
